...
@NamedNativeQueries({
        ...
        @NamedNativeQuery(name = "Playlist.addSong", query = "INSERT INTO Lista_cancion (:id_playlist,:id_song)"),
        @NamedNativeQuery(name = "Playlist.addSub", query = "INSERT INTO Suscripcion (:id_playlist,:id_user)"),
